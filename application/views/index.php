    ...
    <head>
        ...
        <script>
            (adsbygoogle = window.adsbygoogle || []).push({
                google_ad_client: "ca-pub-5569130146252921",
        ...
        <div id="PageContainer" class="is-moved-by-drawer">
                                ...
                                <div class="grid--full grid--table">
                                    ...
                                    <div class="grid__item large--show medium-down--hide smal--hide">
                                        ...
                                        <div class="grid__item large--two-fifths nav-search">
                                            <form action="https://www.google.com/search" method="get" name="searchform" target="_blank" class="input-group search-bar" style="position: relative;">
                                                <input type="hidden" name="sitesearch" value="aamedsupplies.com">
                                                <input type="search" name="q" value="" placeholder="Search ......" class="input-group-field st-default-search-input" aria-label="Search something" autocomplete="on">
                                        ...
                                        <div class="grid__item large--three-tenths nav-cart">
                                            ...
                                            <span class="text">CALL : <span class="name">(703) 498 6383</span></span>
            ...
            <div class="content">
                <div class="index-sections">            
                    <div id="html-section-1492612957563" class="html-section index-section revolution-slider">
                        <div data-section-id="1492612957563" data-section-type="slideshow-section" style="padding-top:px; padding-bottom:20px;">
                                    ...
                                    <div>
                                        ...
                                        <div id="wowslider-container1">
                                            <div class="ws_images"><ul>
                                                    <li><img src="<?= base_url(); ?>assets/images/equip.jpg" alt="Fish Pediatric Compressor Nebulizer : slider jquery " title="EXCLUSIVE DEALS for Registered Customers Get access to amazing exclusive promotions and deals now!" id="wows1_0"/> EXCLUSIVE DEALS for Registered Customers Get access to amazing exclusive promotions and deals now!</li>
                                                    <li><img src="<?= base_url(); ?>assets/images/meds_all.png" alt="Fish Pediatric Compressor Nebulizer: jquery image slider " title="Fish Pediatric Compressor Nebulizer" id="wows1_1"/>We accept Virginia Medicaid and other private insurances:</li>
                                                    <li><img src="<?= base_url(); ?>assets/img/top-home-medical-on-when-it-comes-to-home-medical-equipment-cardinal-drug-store-home-medical.jpg" alt="Fish Pediatric Compressor Nebulizer: jquery slideshow " title="Nutritional" id="wows1_2"/>Fish Pediatric Compressor Nebulizer</li>
                                                </ul></div>
                                            <div class="ws_bullets"><div>
                                                    <a href="#" title="EXCLUSIVE DEALS for Registered Customers Get access to amazing exclusive promotions and deals now!"><img src="<?= base_url(); ?>assets/images/equip.jpg" alt="Nutritional"/>Fish Pediatric Compressor Nebulizer </a>
                                                    <a href="#" title="We accept Virginia Medicaid and other private insurances:"><img src="<?= base_url(); ?>assets/images/meds_all.png" alt="Mount Foraker"/>Fish Pediatric Compressor Nebulizer</a>
                                                    <a href="#" title="Nutritional"><img src="<?= base_url(); ?>assets/img/top-home-medical-on-when-it-comes-to-home-medical-equipment-cardinal-drug-store-home-medical.jpg" alt="Nutritional"/>Nutritional </a>
                                                </div></div>
                                            <div class="ws_shadow"></div>
                                        </div>

                                        <script type="text/javascript" src="<?= base_url(); ?>assets/js/wowslider.js"></script>
                                        <script type="text/javascript" src="<?= base_url(); ?>assets/js/script.js"></script>        <!-- End WOWSlider.com BODY section -->
                                        <br />
                                    </div>
                                                    ...
                                                    <div class="grid__item small--one-half medium-up--one-quarter one-quarter">
                                                        <div class="grid-view-item">
                                                            ...
                                                            <div class="h4 grid-view-item__title">
                                                                <a href="./product.html"><?php echo $l->Name . ' '; ?></a>
                                                            </div>
                ...
                <div class="grid__item contact-wrapper">
                    ...
                    <div class="grid__item large--one-half" style="padding-left: 0;">
                        ...
                        <ul>
                            ...
                            <li class="phone"><i class="fa fa-fax"></i>Fax: (703) 651 5185</li>
                        </ul>
                    </div>
